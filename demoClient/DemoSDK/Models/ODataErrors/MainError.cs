...
using System.Linq;
using System;
namespace DemoSDK.Models.ODataErrors {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public DemoSDK.Models.ODataErrors.InnerError? InnerError { get; set; }
#nullable restore
#else
        public DemoSDK.Models.ODataErrors.InnerError InnerError { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"innerError", n => { InnerError = n.GetObjectValue<DemoSDK.Models.ODataErrors.InnerError>(DemoSDK.Models.ODataErrors.InnerError.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<DemoSDK.Models.ODataErrors.InnerError>("innerError", InnerError);
