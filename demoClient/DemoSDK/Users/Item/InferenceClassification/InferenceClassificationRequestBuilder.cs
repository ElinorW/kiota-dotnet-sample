...
using DemoSDK.Users.Item.InferenceClassification.Overrides;
...
using System;
namespace DemoSDK.Users.Item.InferenceClassification {
    /// <summary>
    ...
    public class InferenceClassificationRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="DemoSDK.Models.InferenceClassification"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DemoSDK.Models.InferenceClassification?> GetAsync(Action<RequestConfiguration<InferenceClassificationRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DemoSDK.Models.InferenceClassification> GetAsync(Action<RequestConfiguration<InferenceClassificationRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<DemoSDK.Models.InferenceClassification>(requestInfo, DemoSDK.Models.InferenceClassification.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<DemoSDK.Models.InferenceClassification?> PatchAsync(DemoSDK.Models.InferenceClassification body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DemoSDK.Models.InferenceClassification> PatchAsync(DemoSDK.Models.InferenceClassification body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(DemoSDK.Models.InferenceClassification body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(DemoSDK.Models.InferenceClassification body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
