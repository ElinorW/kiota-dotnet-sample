...
using DemoSDK.Users.Item.MailFolders.Count;
using DemoSDK.Users.Item.MailFolders.Item;
...
using System;
namespace DemoSDK.Users.Item.MailFolders {
    /// <summary>
    ...
    public class MailFoldersRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>Gets an item from the demoSDK.users.item.mailFolders.item collection</summary>
