...
using DemoSDK.Users.Item.MailFolders.Item.ChildFolders.Count;
using DemoSDK.Users.Item.MailFolders.Item.ChildFolders.Item;
...
using System;
namespace DemoSDK.Users.Item.MailFolders.Item.ChildFolders {
    /// <summary>
    ...
    public class ChildFoldersRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>Gets an item from the demoSDK.users.item.mailFolders.item.childFolders.item collection</summary>
        /// <param name="position">The unique identifier of mailFolder</param>
        /// <returns>A <see cref="DemoSDK.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder"/></returns>
        public DemoSDK.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("mailFolder%2Did1", position);
                return new DemoSDK.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
